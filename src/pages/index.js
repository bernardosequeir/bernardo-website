...
export default ({ data }) => (
  <Layout style={css`width: 80% !important;`}>
    ...
    `}>
      ...
      <h3 css={css`text-align: center; margin-bottom: 1rem!important`} >This website houses blog posts about programming, web security, and all the other things I'll eventually decide to write about.</h3>
